export const en = {
  ...
  truthOrDare: {
    ...
    instruction1: 'Tap "Spin the Wheel" to randomly select Truth or Dare',
    instruction2: 'The wheel adjusts probabilities - if Truth appears often, Dare becomes more likely next time',
